...
{
    public class SellerPlatformBillingReportRequest : ReportRequest
    {
        public override ReportType ReportType
        {
            get
            {
                return ReportType.SellerPlatformBilling;
            }
        }

        public SellerPlatformBillingReportColumn[] Columns { get; set; }
        ...
        private static Dictionary<int, string> _reportColumns = typeof(SellerPlatformBillingReportColumn).ToDictionary();
