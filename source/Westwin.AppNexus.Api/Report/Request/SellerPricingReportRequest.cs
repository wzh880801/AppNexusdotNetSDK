...
{
    public class SellerPricingReportRequest : ReportRequest
    {
        public override ReportType ReportType
        {
            get
            {
                return ReportType.SellerPricingReport;
            }
        }

        public SellerPricingReportColumn[] Columns { get; set; }
        ...
        private static Dictionary<int, string> _reportColumns = typeof(SellerPricingReportColumn).ToDictionary();
