...
{
    public class TtuiPlatformSellerReportRequest : ReportRequest
    {
        public override ReportType ReportType
        {
            get
            {
                return ReportType.TtuiPlatformSeller;
            }
        }

        public TtuiPlatformSellerReportColumn[] Columns { get; set; }
        ...
        private static Dictionary<int, string> _reportColumns = typeof(TtuiPlatformSellerReportColumn).ToDictionary();
