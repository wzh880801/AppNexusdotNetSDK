...
{
    public class BuyerPricingReportRequest : ReportRequest
    {
        public override ReportType ReportType
        {
            get
            {
                return ReportType.BuyerPricingReport;
            }
        }

        public BuyerPricingReportColumn[] Columns { get; set; }
        ...
        private static Dictionary<int, string> _reportColumns = typeof(BuyerPricingReportColumn).ToDictionary();
