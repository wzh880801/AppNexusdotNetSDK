...
{
    public class SiteDomainPerformanceReportRequest : ReportRequest
    {
        public override ReportType ReportType
        {
            get
            {
                return ReportType.SiteDomainPerformance;
            }
        }

        public SiteDomainPerformanceReportColumn[] Columns { get; set; }
        ...
        private static Dictionary<int, string> _reportColumns = typeof(SiteDomainPerformanceReportColumn).ToDictionary();
