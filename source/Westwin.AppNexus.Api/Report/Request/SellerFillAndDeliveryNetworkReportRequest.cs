...
{
    public class SellerFillAndDeliveryNetworkReportRequest : ReportRequest
    {
        public override ReportType ReportType
        {
            get
            {
                return ReportType.SellerFillAndDeliveryNetwork;
            }
        }

        public SellerFillAndDeliveryNetworkReportColumn[] Columns { get; set; }
        ...
        private static Dictionary<int, string> _reportColumns = typeof(SellerFillAndDeliveryNetworkReportColumn).ToDictionary();
