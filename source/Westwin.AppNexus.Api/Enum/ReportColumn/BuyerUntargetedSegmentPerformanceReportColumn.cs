...
{
    public enum BuyerUntargetedSegmentPerformanceReportColumn : int
    {
        /// <summary>
        ...
        /// Type is int. This column is not in havings
        /// </summary>
        [EnumDescription("segment_owner_member_id")]
        SegmentOwnerMemberId,

        /// <summary>
        /// Type is string. This column is not in havings
        /// </summary>
        [EnumDescription("segment_owner_member_name")]
        SegmentOwnerMemberName,

        /// <summary>
        /// Type is int. This column is not in havings
        /// </summary>
        [EnumDescription("is_advertiser_segment")]
        IsAdvertiserSegment,
