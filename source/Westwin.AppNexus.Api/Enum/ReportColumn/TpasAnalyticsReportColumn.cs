...
{
    public enum TpasAnalyticsReportColumn : int
    {
        /// <summary>
        ...
        /// Type is int. This column is in havings
        /// </summary>
        [EnumDescription("tpas_imps")]
        TpasImps,

        /// <summary>
        /// Type is int. This column is in havings
        /// </summary>
        [EnumDescription("tpas_clicks")]
        TpasClicks,

        /// <summary>
        /// Type is int. This column is in havings
        /// </summary>
        [EnumDescription("tpas_post_view_convs")]
        TpasPostViewConvs,

        /// <summary>
        /// Type is int. This column is in havings
        /// </summary>
        [EnumDescription("tpas_post_click_convs")]
        TpasPostClickConvs,

        /// <summary>
        /// Type is int. This column is in havings
        /// </summary>
        [EnumDescription("tpas_total_convs")]
        TpasTotalConvs,

        /// <summary>
        /// Type is string. This column is not in havings
        /// </summary>
        [EnumDescription("tpas_pixel_name")]
        TpasPixelName,

        /// <summary>
        /// Type is int. This column is not in havings
        /// </summary>
        [EnumDescription("tpas_id")]
        TpasId,

        /// <summary>
        /// Type is int. This column is not in havings
        /// </summary>
        [EnumDescription("tpas_name")]
        TpasName,

        /// <summary>
        /// Type is int. This column is in havings
        /// </summary>
        [EnumDescription("creative_is_cross_io")]
        CreativeIsCrossIo,

        /// <summary>
        /// Type is int. This column is in havings
        /// </summary>
        [EnumDescription("creative_is_cross_campaign")]
        CreativeIsCrossCampaign,
        ...
        /// Type is string. This column is not in havings
        /// </summary>
        [EnumDescription("tpas_placement_id")]
        TpasPlacementId,
